...
**Database**: Focalboard Personal Server supports both SQLite (default) and PostgreSQL databases. To use **Supabase** as your database backend, see [SUPABASE_SETUP.md](SUPABASE_SETUP.md) for setup instructions.
